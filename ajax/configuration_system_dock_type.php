...
switch($command) {
  case 'add_system_dock_type_configuration':
    ...
    $butr_command = new Butr\CommandAddSystemDockTypeConfiguration();
  ...
  case 'modify_system_dock_type_configuration':
    ...
    $butr_command = new Butr\CommandModifySystemDockTypeConfiguration();
  ...
  case 'remove_system_dock_type_configuration':
    ...
    $butr_command = new Butr\CommandRemoveSystemDockTypeConfiguration();
