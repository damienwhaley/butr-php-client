...
switch($command) {
  case 'add_security_client_type_configuration':
    ...
    $butr_command = new Butr\CommandAddSecurityClientTypeConfiguration();
  ...
  case 'modify_security_client_type_configuration':
    ...
    $butr_command = new Butr\CommandModifySecurityClientTypeConfiguration();
  ...
  case 'remove_security_client_type_configuration':
    ...
    $butr_command = new Butr\CommandRemoveSecurityClientTypeConfiguration();
