...
switch($command) {
  case 'add_module':
    ...
    $butr_command = new Butr\CommandAddModule();
    $butr_command->setAll($module_name, $magic, $description, $is_active);    
  ...
  case 'modify_module':
    ...
    $butr_command = new Butr\CommandModifyModule();
    $butr_command->setAll($uuid, $module_name, $magic, $description, $is_active);
    $butr_command->setAuthenticationSnippet($butr_authentication->generateSnippet());
    $butr_command->prepareCommand();
    echo $butr_command->sendCommand();
  ...
  case 'remove_module':
    ...
    $butr_command = new Butr\CommandRemoveModule();
