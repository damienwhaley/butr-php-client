...
switch($command) {
  case 'add_partition':
    ...
    $partition_name = (isset($_POST['partition_name'])) ? $_POST['partition_name'] : '';
    $description = (isset($_POST['description'])) ? $_POST['description'] : '';
    $is_active = (isset($_POST['is_active'])) ? $_POST['is_active'] : '';
    
    $butr_command = new Butr\CommandAddPartition();
    $butr_command->setAll($partition_name, $description, $is_active);
  ...
  case 'modify_partition':
    ...
    $butr_command = new Butr\CommandModifyPartition();
    $butr_command->setAll($uuid, $partition_name, $description, $is_active);
    $butr_command->setAuthenticationSnippet($butr_authentication->generateSnippet());
    $butr_command->prepareCommand();
    echo $butr_command->sendCommand();
  ...
  case 'remove_partition':
    ...
    $butr_command = new Butr\CommandRemovePartition();
