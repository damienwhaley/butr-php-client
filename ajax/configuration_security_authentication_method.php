...
switch($command) {
  case 'add_security_authentication_method_configuration':
    ...
    $butr_command = new Butr\CommandAddSecurityAuthenticationMethodConfiguration();
    $butr_command->setAll($name_label, $display_label, $description, $magic, $weighting, $is_active);
  ...
  case 'modify_security_authentication_method_configuration':
    ...
    $butr_command = new Butr\CommandModifySecurityAuthenticationMethodConfiguration();
    $butr_command->setAll($uuid, $name_label, $display_label, $description, $magic, $weighting, $is_active);  
    $butr_command->setAuthenticationSnippet($butr_authentication->generateSnippet());
    $butr_command->prepareCommand();
    echo $butr_command->sendCommand();
  ...
  case 'remove_security_authentication_method_configuration':
    ...
    $butr_command = new Butr\CommandRemoveSecurityAuthenticationMethodConfiguration();
