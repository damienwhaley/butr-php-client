...
/**
 * This tests the CommandModifyDock class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifyDockTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifyDock();
    ...
    $this->_weighting = 10;
    $this->_picture_path = 'country_code';
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_uuid, $this->_security_client_type_uuid, $this->_dock_name,
  ...
  public function testCommandName() {
    $this->assertEquals('modify_dock', $this->_testClass->getCommandName());
  }
