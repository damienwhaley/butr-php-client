...
/**
 * This tests the CommandListCountries class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListCountriesTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListCountries();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_countries', $this->_testClass->getCommandName());
  }
