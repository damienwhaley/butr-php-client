...
/**
 * This tests the CommandFetchPartition class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchPartitionTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchPartition();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_partition', $this->_testClass->getCommandName());
  }
