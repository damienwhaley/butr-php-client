...
/**
 * This tests the CommandListPartitions class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListPartitionsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListPartitions();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_partitions', $this->_testClass->getCommandName());
  }
