...
/**
 * This tests the CommandRemovePartition class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemovePartitionTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemovePartition();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_partition', $this->_testClass->getCommandName());
  }
