...
/**
 * This tests the CommandFetchSecurityClientTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchSecurityClientTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchSecurityClientTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_security_client_type_configuration', $this->_testClass->getCommandName());
  }
