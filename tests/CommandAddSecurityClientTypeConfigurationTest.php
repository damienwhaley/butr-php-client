...
/**
 * This tests the CommandAddSecurityClientTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandAddSecurityClientTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddSecurityClientTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('add_security_client_type_configuration', $this->_testClass->getCommandName());
  }
