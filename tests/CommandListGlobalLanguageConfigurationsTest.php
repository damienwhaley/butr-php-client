...
/**
 * This tests the CommandListGlobalLangugeConfigurations class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListGlobalLanguageConfigurationsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListGlobalLanguageConfigurations();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_global_language_configurations', $this->_testClass->getCommandName());
  }
