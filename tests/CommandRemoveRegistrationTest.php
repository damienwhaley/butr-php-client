...
/**
 * This tests the CommandRemoveRegistration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveRegistrationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveRegistration();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_registration', $this->_testClass->getCommandName());
  }
