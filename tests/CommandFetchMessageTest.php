...
/**
 * This tests the CommandFetchMesage class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchMessageTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchMessage();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_message', $this->_testClass->getCommandName());
  }
