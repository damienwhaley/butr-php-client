...
/**
 * This tests the CommandListSystemLogTypeConfigurations class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListSystemLogTypeConfigurationsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListSystemLogTypeConfigurations();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_system_log_type_configurations', $this->_testClass->getCommandName());
  }
