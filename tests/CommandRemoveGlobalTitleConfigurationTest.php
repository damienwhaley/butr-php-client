...
/**
 * This tests the CommandRemoveGlobalTitleConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveGlobalTitleConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveGlobalTitleConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_global_title_configuration', $this->_testClass->getCommandName());
  }
