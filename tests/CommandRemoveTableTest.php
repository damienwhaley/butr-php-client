...
/**
 * This tests the CommandRemoveTable class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveTableTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveTable();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_table', $this->_testClass->getCommandName());
  }
