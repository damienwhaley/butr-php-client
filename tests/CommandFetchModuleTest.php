...
/**
 * This tests the CommandFetchModule class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchModuleTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchModule();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_module', $this->_testClass->getCommandName());
  }
