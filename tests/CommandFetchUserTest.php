...
/**
 * This tests the CommandFetchUser class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchUserTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchUser();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_user', $this->_testClass->getCommandName());
  }
