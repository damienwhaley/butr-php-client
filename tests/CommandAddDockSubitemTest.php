...
class SelectEqualsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddDockSubitem();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_dock_item_uuid, $this->_system_dock_type_uuid,
  ...
  public function testCommandName() {
    $this->assertEquals('add_dock_subitem', $this->_testClass->getCommandName());
  }
