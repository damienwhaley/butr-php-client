...
/**
 * This tests the CommandRemoveGlobalLanguageConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveGlobalLanguageConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveGlobalLanguageConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_global_language_configuration', $this->_testClass->getCommandName());
  }
