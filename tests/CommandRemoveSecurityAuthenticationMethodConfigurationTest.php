...
/**
 * This tests the CommandRemoveSecurityAuthenticationMethodConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveSecurityAuthenticationMethodConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveSecurityAuthenticationMethodConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_security_authentication_method_configuration', $this->_testClass->getCommandName());
  }
