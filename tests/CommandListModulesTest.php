...
/**
 * This tests the CommandListModules class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListModulesTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListModules();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_modules', $this->_testClass->getCommandName());
  }
