...
class SelectEqualsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddMessage();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_module_uuid, $this->_message_name, $this->_magic,
  ...
  public function testCommandName() {
    $this->assertEquals('add_message', $this->_testClass->getCommandName());
  }
