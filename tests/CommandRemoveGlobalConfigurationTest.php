...
/**
 * This tests the CommandRemoveGlobalConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveGlobalConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveGlobalConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_global_configuration', $this->_testClass->getCommandName());
  }
