...
/**
 * This tests the CommandRemoveDockItem class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveDockItemTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveDockItem();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_dock_item', $this->_testClass->getCommandName());
  }
