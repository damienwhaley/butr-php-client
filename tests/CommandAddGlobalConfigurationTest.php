...
/**
 * This tests the CommandAddGlobalConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandAddGlobalConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddGlobalConfiguration();
    $this->_name_label = '';
    $this->_display_label = '';
    $this->_magic = '';
    $this->_description = '';
  ...
  public function testCommandName() {
    $this->assertEquals('add_global_configuration', $this->_testClass->getCommandName());
  }
