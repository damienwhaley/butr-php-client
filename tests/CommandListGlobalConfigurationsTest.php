...
/**
 * This tests the CommandListGlobalConfigurations class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListGlobalConfigurationsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListGlobalConfigurations();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_global_configurations', $this->_testClass->getCommandName());
  }
