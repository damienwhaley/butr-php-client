...
/**
 * This tests the CommandAddSecurityAuthenticationMethodConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandAddSecurityAuthenticationMethodConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddSecurityAuthenticationMethodConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('add_security_authentication_method_configuration', $this->_testClass->getCommandName());
  }
