...
/**
 * This tests the CommandModifyGlobalTitleConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifyGlobalTitleConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifyGlobalTitleConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('modify_global_title_configuration', $this->_testClass->getCommandName());
  }
