...
/**
 * This tests the CommandListPermissions class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListPermissionsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListPermissions();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_permissions', $this->_testClass->getCommandName());
  }
