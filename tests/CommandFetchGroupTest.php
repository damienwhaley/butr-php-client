...
/**
 * This tests the CommandFetchGroup class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchGroupTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchGroup();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_group', $this->_testClass->getCommandName());
  }
