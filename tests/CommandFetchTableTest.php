...
/**
 * This tests the CommandFetchTable class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchTableTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchTable();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_table', $this->_testClass->getCommandName());
  }
