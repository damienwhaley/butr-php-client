...
/**
 * This tests the CommandAddSystemLogTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandAddSystemLogTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddSystemLogTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('add_system_log_type_configuration', $this->_testClass->getCommandName());
  }
