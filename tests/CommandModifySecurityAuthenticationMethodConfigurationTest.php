...
/**
 * This tests the CommandModifSyecurityAuthenticationMethodConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifySecurityAuthenticationMethodConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifySecurityAuthenticationMethodConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('modify_security_authentication_method_configuration', $this->_testClass->getCommandName());
  }
