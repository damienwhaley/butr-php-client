...
/**
 * This tests the CommandListDockItems class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListDockItemsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListDockItems();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_dock_items', $this->_testClass->getCommandName());
  }
