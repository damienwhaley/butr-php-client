...
/**
 * This tests the CommandListRoles class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListRolesTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListRoles();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_roles', $this->_testClass->getCommandName());
  }
