...
/**
 * This tests the CommandFetchGlobalLanguageConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchGlobalLanguageConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchGlobalLanguageConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_global_language_configuration', $this->_testClass->getCommandName());
  }
