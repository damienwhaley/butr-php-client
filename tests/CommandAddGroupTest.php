...
/**
 * This tests the CommandAddGroup class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandAddGroupTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddGroup();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_group_name, $this->_display_name,
  ...
  public function testCommandName() {
    $this->assertEquals('add_group', $this->_testClass->getCommandName());
  }
