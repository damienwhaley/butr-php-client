...
/**
 * This tests the CommandListSystemDockTypeConfigurations class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListSystemDockTypeConfigurationsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListSystemDockTypeConfigurations();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_system_dock_type_configurations', $this->_testClass->getCommandName());
  }
