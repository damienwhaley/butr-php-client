...
/**
 * This tests the CommandRemoveSystemLogTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveSystemLogTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveSystemLogTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_system_log_type_configuration', $this->_testClass->getCommandName());
  }
