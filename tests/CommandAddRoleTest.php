...
/**
 * This tests the CommandAddRole class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandAddRoleTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddRole();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_partition_uuid, $this->_role_name,
  ...
  public function testCommandName() {
    $this->assertEquals('add_role', $this->_testClass->getCommandName());
  }
