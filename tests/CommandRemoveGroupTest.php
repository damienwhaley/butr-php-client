...
/**
 * This tests the CommandRemoveGroup class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveGroupTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveGroup();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_group', $this->_testClass->getCommandName());
  }
