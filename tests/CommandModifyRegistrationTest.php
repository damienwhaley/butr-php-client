...
/**
 * This tests the CommandModifyRegistration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifyRegistrationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifyRegistration();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_uuid, $this->_api_public, $this->_api_private,
  ...
  public function testCommandName() {
    $this->assertEquals('modify_registration', $this->_testClass->getCommandName());
  }
