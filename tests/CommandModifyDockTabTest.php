...
/**
 * This tests the CommandModifyDockTab class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifyDockTabTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifyDockTab();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_uuid, $this->_dock_item_uuid, $this->_dock_subitem_uuid,
  ...
  public function testCommandName() {
    $this->assertEquals('modify_dock_tab', $this->_testClass->getCommandName());
  }
