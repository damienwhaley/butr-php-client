...
/**
 * This tests the CommandRemoveSecurityClientTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveSecurityClientTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveSecurityClientTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_security_client_type_configuration', $this->_testClass->getCommandName());
  }
