...
/**
 * This tests the CommandModifySystemLogTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifySystemLogTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifySystemLogTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('modify_system_log_type_configuration', $this->_testClass->getCommandName());
  }
