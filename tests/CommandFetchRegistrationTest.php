...
/**
 * This tests the CommandFetchRegistration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchRegistrationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchRegistration();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_registration', $this->_testClass->getCommandName());
  }
