...
/**
 * This tests the CommandRemoveSystemDockTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveSystemDockTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveSystemDockTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_system_dock_type_configuration', $this->_testClass->getCommandName());
  }
