...
/**
 * This tests the CommandFetchSecurityAuthenticationMethodConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchSecurityAuthenticationMethodConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchSecurityAuthenticationMethodConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_security_authentication_method_configuration', $this->_testClass->getCommandName());
  }
