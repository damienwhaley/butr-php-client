...
/**
 * This tests the CommandModifyTable class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifyTableTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifyTable();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_uuid, $this->_table_name);
  ...
  public function testCommandName() {
    $this->assertEquals('modify_table', $this->_testClass->getCommandName());
  }
