 ...
 */
class CommandRemoveCountryTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveCountry();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_country', $this->_testClass->getCommandName());
  }
