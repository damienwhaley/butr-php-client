...
/**
 * This tests the CommandListMessages class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListMessagesTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListMessages();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_messages', $this->_testClass->getCommandName());
  }
