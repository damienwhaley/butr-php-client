...
/**
 * This tests the CommandModifySystemDockTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifySystemDockTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifySystemDockTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('modify_system_dock_type_configuration', $this->_testClass->getCommandName());
  }
