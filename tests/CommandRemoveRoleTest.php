...
/**
 * This tests the CommandRemoveRole class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveRoleTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveRole();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_role', $this->_testClass->getCommandName());
  }
