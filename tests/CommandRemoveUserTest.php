...
/**
 * This tests the CommandRemoveUser class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveUserTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveUser();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_user', $this->_testClass->getCommandName());
  }
