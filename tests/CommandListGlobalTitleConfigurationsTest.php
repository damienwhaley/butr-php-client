...
/**
 * This tests the CommandListGlobalTitleConfigurations class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListGlobalTitleConfigrationsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListGlobalTitleConfigurations();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_global_title_configurations', $this->_testClass->getCommandName());
  }
