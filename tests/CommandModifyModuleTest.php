...
/**
 * This tests the CommandModifyModule class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifyModuleTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifyModule();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_uuid, $this->_module_name, $this->_magic,
  ...
  public function testCommandName() {
    $this->assertEquals('modify_module', $this->_testClass->getCommandName());
  }
