...
/**
 * This tests the CommandFetchGlobalTitleConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchGlobalTitleConfigurationTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchGlobalTitleConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_global_title_configuration', $this->_testClass->getCommandName());
  }
