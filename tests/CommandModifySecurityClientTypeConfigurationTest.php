...
/**
 * This tests the CommandModifySecurityClientTypeConfiguration class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandModifySecurityClientTypeConfigurationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandModifySecurityClientTypeConfiguration();
  ...
  public function testCommandName() {
    $this->assertEquals('modify_security_client_type_configuration', $this->_testClass->getCommandName());
  }
