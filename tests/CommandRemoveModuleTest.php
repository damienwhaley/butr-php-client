...
/**
 * This tests the CommandRemoveModule class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveModuleTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveModule();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_module', $this->_testClass->getCommandName());
  }
