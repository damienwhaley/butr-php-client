...
/**
 * This tests the CommandFetchRole class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchRoleTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchRole();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_role', $this->_testClass->getCommandName());
  }
