...
/**
 * This tests the CommandFetchDock class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchDockTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchDock();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_dock', $this->_testClass->getCommandName());
  }
