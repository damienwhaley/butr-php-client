...
/**
 * This tests the CommandListGroups class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListGroupsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListGroups();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_groups', $this->_testClass->getCommandName());
  }
