...
/**
 * This tests the CommandFetchDockItem class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchDockItemTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchDockItem();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_dock_item', $this->_testClass->getCommandName());
  }
