...
class CommandListSecurityClientTypeConfigurationsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListSecurityClientTypeConfigurations();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_security_client_type_configurations', $this->_testClass->getCommandName());
  }
