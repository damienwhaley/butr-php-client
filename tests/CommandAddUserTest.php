...
class SelectEqualsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddUser();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_global_title_uuid, $this->_first_name,
  ...
  public function testCommandName() {
    $this->assertEquals('add_user', $this->_testClass->getCommandName());
  }
