...
class CommandAddPermissionTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandAddPermission();
  ...
  public function testSetAll() {
    ...
    $this->_testClass->setAll($this->_module_uuid, $this->_permission_name, 
...
public function testSetImportance() {
  ...
  public function testCommandName() {
    $this->assertEquals('add_permission', $this->_testClass->getCommandName());
  }
