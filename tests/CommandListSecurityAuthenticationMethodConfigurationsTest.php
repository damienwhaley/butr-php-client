...
/**
 * This tests the CommandListSecurityAuthenticationMethodConfigurations class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListSecurityAuthenticationMethodConfigurationsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListSecurityAuthenticationMethodConfigurations();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_security_authentication_method_configurations', $this->_testClass->getCommandName());
  }
