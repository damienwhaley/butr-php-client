...
/**
 * This tests the CommandRemoveMessage class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveMessageTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveMessage();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_message', $this->_testClass->getCommandName());
  }
