 ...
 */
class CommandFetchCountryTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchCountry();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_country', $this->_testClass->getCommandName());
  }
