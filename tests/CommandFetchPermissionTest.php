...
/**
 * This tests the CommandFetchPermission class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchPermissionTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchPermission();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_permission', $this->_testClass->getCommandName());
  }
