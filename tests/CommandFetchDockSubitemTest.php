...
/**
 * This tests the CommandFetchDockSubitem class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandFetchDockSubitemTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandFetchDockSubitem();
  ...
  public function testCommandName() {
    $this->assertEquals('fetch_dock_subitem', $this->_testClass->getCommandName());
  }
