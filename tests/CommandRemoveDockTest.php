...
/**
 * This tests the CommandRemoveDock class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandRemoveDockTest extends PHPUnit_Framework_TestCase
{
  protected $_testClass;
  protected $_uuid;
  
  public function setUp() {
    $this->_testClass = new Butr\CommandRemoveDock();
  ...
  public function testCommandName() {
    $this->assertEquals('remove_dock', $this->_testClass->getCommandName());
  }
