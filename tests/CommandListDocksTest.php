...
/**
 * This tests the CommandListDocks class
 * @author Damien Whaley <damien@whalebonestudios.com>
 */
class CommandListDocksTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp() {
    $this->_testClass = new Butr\CommandListDocks();
    $this->_offset = 10;
  ...
  public function testCommandName() {
    $this->assertEquals('list_docks', $this->_testClass->getCommandName());
  }
