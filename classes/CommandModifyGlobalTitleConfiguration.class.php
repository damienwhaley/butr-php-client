...
/**
  * CommandModifyGlobalTitleConfiguration class.
  * This implements the functionality required to call the
  * modify_global_title_configuration message.
  */
class CommandModifyGlobalTitleConfiguration extends BaseCommand {
  ...
  public function __construct() {
    parent::__construct();
    $this->_command_name = 'modify_global_title_configuration';
    $this->_uuid = '';
    $this->_name_label = '';
    $this->_display_label = '';
    $this->_description = '';
   ...
   *   - The is_active for the record to be modified.
   */
  public function setAll($uuid, $name_label, $display_label, $description, $weighting, $is_active){
    $this->setUuid($uuid);
