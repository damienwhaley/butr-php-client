...
/**
  * CommandAddSecurityAuthenticationMethodConfiguration class.
  * This implements the functionality required to call the
  * add_security_authentication_method_configuration message.
  */
class CommandAddSecurityAuthenticationMethodConfiguration extends BaseCommand {
  ...
  public function __construct() {
    parent::__construct();
    $this->_command_name = 'add_security_authentication_method_configuration';
    $this->resetAll();
  }
   ...
   *   - The is_active for the record to be added.
   */
  public function setAll($name_label, $display_label, $description, $magic,
    $weighting, $is_active){
