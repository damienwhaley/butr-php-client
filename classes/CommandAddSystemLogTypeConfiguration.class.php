...
/**
  * CommandAddSystemLogTypeConfiguration class.
  * This implements the functionality required to call the
  * add_system_log_type_configuration message.
  */
class CommandAddSystemLogTypeConfiguration extends BaseCommand {
  ...
  public function __construct() {
    parent::__construct();
    $this->_command_name = 'add_system_log_type_configuration';
    $this->_name_label = '';
    $this->_display_label = '';
    $this->_description = '';
    $this->_magic = '';
