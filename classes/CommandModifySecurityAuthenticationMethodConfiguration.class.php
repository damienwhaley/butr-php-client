...
/**
  * CommandModifySecurityAuthenticationMethodConfiguration class.
  * This implements the functionality required to call the
  * modify_security_authentication_method_configuration message.
  */
class CommandModifySecurityAuthenticationMethodConfiguration extends BaseCommand {
  ...
  public function __construct() {
    parent::__construct();
    $this->_command_name = 'modify_security_authentication_method_configuration';
    $this->resetAll();
  }
