...
/**
  * CommandModifyGlobalConfiguration class.
  * This implements the functionality required to call the
  * add_global_configuration message.
  */
class CommandModifyGlobalConfiguration extends BaseCommand {
  ...
  /**
   * String containing the text_setting for the record to be modified.
   * @var string
   */
  private $_text_setting;
  
  /**
   * Integer containing the integer_setting for the record to be modified.
   * @var integer
   */
  private $_integer_setting;
  
  /**
   * Float containing the float_setting for the record to be modified.
   * @var float
   */
  private $_float_setting;
  
  /**
   * Date containing the datetime_setting for the record to be modified.
   * @var DateTime
   */
  private $_datetime_setting;
  
  /**
   * String containing the uuid_setting for the record to be modified.
   * @var string
   */
  private $_uuid_setting;
  
  /**
   * Integer containing the bit_setting for the record to be modified.
   * @var integer
   */
  ...
  */
   ...
   *   - The bit_setting for the record to be modified.
   */
  public function setAll($uuid, $name_label, $display_label, $magic, $description, $text_setting,
    $integer_setting, $float_setting, $datetime_setting, $uuid_setting, $bit_setting){
    $this->setUuid($uuid);
