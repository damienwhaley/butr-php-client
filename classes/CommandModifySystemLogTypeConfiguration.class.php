...
/**
  * CommandModifySystemLogTypeConfiguration class.
  * This implements the functionality required to call the
  * modify_system_log_type_configuration message.
  */
class CommandModifySystemLogTypeConfiguration extends BaseCommand {
  ...
  public function __construct() {
    parent::__construct();
    $this->_command_name = 'modify_system_log_type_configuration';
    $this->resetAll();
  }
